...
Questo approccio risponde alla domanda `` il lato $(u, v)$ e la foresta $A$, esiste un percorso tra $u$ e $v$?'', ed è implementato dal metodo \codeinline{are\_connected(source, target)} della classe \codeinline{DFSCycleDetection}. \\
