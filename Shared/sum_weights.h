 ...
 */
template <typename Label, typename Weight, typename It, typename = typename std::enable_if<std::is_same<typename std::iterator_traits<It>::value_type, Edge<Label, Weight>>::value>::type>
