...
std::vector<Edge<Label, Weight>> prim_k_heap_mst(
    AdjacencyMapGraph<Label, Weight>&& adj_map_graph) noexcept {
    ...
    auto min_pq(priority_queue::make_min_k_priority_queue<K, IsAlreadyHeap>(std::move(keys),
                                                                            std::move(vertexes)));
